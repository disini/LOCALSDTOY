    ...
    var STNPlayer = /** @class */ (function () {
        ...
        STNPlayer.prototype.run = function (data) {
            ...
            if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
                ...
                console.error("linkProgram error : ".concat(info));
            }
            //gl 状态
            ...
            this.loop = function () {
                ...
                baseDraw();
                //循环刷新
                requestAnimationFrame(_this.loop); //注意:这里遇到一个坑，如果用setTimeout 作为循环泵，会有严重的卡顿情况
                frame++;
            };
            this.loop();
        };
        ...
        STNPlayer.prototype.ckShaderCompileS = function (sh, info) {
            ...
            if (s == false) {
                ...
                console.error("compiles shader error : ".concat(info, " \n ").concat(log, " "));
            }
        };
            ...
            return new Promise(function (res, rej) {
                    ...
                    if (xhreq.readyState == 4) {
                        switch (xhreq.status) {
                            case 200:
                                ...
                                break;
                            case 404:
                                rej(new Error("got a 404: ".concat(url)));
                                break;
                            default:
                        }
                    }
                ...
                xhreq.onloadend = function () {
                    ...
                    if (!_this.enableRetry) {
                        rej(new Error("load fial: ".concat(url)));
                        return;
                    }
                    //加载失败 重试
                    console.log("加载失败 重试");
                ...
                xhreq.onerror = function (ev) {
                    rej(new Error("load error : ".concat(url)));
                };
            });
        };
        /**
        ...
        Loader.prototype.loadSToy = function (stoyPath) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            stoyCfgUrl = "".concat(stoyPath, "/stoyconfig.json");
                            stoyD = {};
                        ...
                        case 1:
                            ...
                            ICodeUrl = "".concat(stoyPath, "/").concat(IUrl);
